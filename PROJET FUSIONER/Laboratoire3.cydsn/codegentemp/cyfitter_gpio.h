...
#define Pin_FC_0_NUM 5u
#define Pin_FC_0_PORT GPIO_PRT1
...
#define Pin_FC_NUM 5u
#define Pin_FC_PORT GPIO_PRT1
...
/* int_pin */
#define int_pin_0_DRIVEMODE CY_GPIO_DM_PULLUP
#define int_pin_0_INBUF_ENABLED 1u
#define int_pin_0_INIT_DRIVESTATE 1u
#define int_pin_0_INIT_MUXSEL 0u
#define int_pin_0_INPUT_SYNC 2u
#define int_pin_0_INTERRUPT_MODE CY_GPIO_INTR_DISABLE
#define int_pin_0_NUM 7u
#define int_pin_0_PORT GPIO_PRT13
#define int_pin_0_SLEWRATE CY_GPIO_SLEW_FAST
#define int_pin_0_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS
#define int_pin_DRIVEMODE CY_GPIO_DM_PULLUP
#define int_pin_INBUF_ENABLED 1u
#define int_pin_INIT_DRIVESTATE 1u
#define int_pin_INIT_MUXSEL 0u
#define int_pin_INPUT_SYNC 2u
#define int_pin_INTERRUPT_MODE CY_GPIO_INTR_DISABLE
#define int_pin_NUM 7u
#define int_pin_PORT GPIO_PRT13
#define int_pin_SLEWRATE CY_GPIO_SLEW_FAST
#define int_pin_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS

/* volt_max */
#define volt_max_0_DRIVEMODE CY_GPIO_DM_STRONG_IN_OFF
#define volt_max_0_INBUF_ENABLED 0u
#define volt_max_0_INIT_DRIVESTATE 1u
#define volt_max_0_INIT_MUXSEL 0u
#define volt_max_0_INPUT_SYNC 2u
#define volt_max_0_INTERRUPT_MODE CY_GPIO_INTR_DISABLE
#define volt_max_0_NUM 4u
#define volt_max_0_PORT GPIO_PRT9
#define volt_max_0_SLEWRATE CY_GPIO_SLEW_FAST
#define volt_max_0_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS
#define volt_max_DRIVEMODE CY_GPIO_DM_STRONG_IN_OFF
#define volt_max_INBUF_ENABLED 0u
#define volt_max_INIT_DRIVESTATE 1u
#define volt_max_INIT_MUXSEL 0u
#define volt_max_INPUT_SYNC 2u
#define volt_max_INTERRUPT_MODE CY_GPIO_INTR_DISABLE
#define volt_max_NUM 4u
#define volt_max_PORT GPIO_PRT9
#define volt_max_SLEWRATE CY_GPIO_SLEW_FAST
#define volt_max_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS
