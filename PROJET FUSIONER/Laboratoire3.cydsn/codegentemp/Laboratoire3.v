...
module SCB_UART_PDL_v2_0_3 (
	...
	cy_clock_v1_0
		#(.id("d0d3c586-6e70-4c43-a86a-044f3a497134/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_mxs40_gpio_v1_0
		#(.id("d0d3c586-6e70-4c43-a86a-044f3a497134/65f3af6c-759b-4ccb-8c66-5c95ba1f5f4f"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("d0d3c586-6e70-4c43-a86a-044f3a497134/b7e8018e-1ef7-49c0-b5a5-61641a03e31c"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("1"),
...
module SCB_I2C_PDL_v2_0_4 (
	...
	cy_clock_v1_0
		#(.id("20c0f89c-9a8f-4998-9aa5-0e51cb2d86cf/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_mxs40_gpio_v1_0
		#(.id("20c0f89c-9a8f-4998-9aa5-0e51cb2d86cf/69c3b5e8-b094-4d65-b96b-9f4f3a9a8641"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("4"),
		  .ibuf_enabled("1"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("20c0f89c-9a8f-4998-9aa5-0e51cb2d86cf/2aab8a93-e7dd-4bd4-8210-42652cd079c5"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("4"),
		  .ibuf_enabled("1"),
...
module SCB_I2C_PDL_v2_0_5 (
	...
	cy_clock_v1_0
		#(.id("8f886e4d-f729-4462-a528-ce6f612d3b2f/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("645161290.322581"),
		  .is_direct(0),
	...
	cy_mxs40_gpio_v1_0
		#(.id("8f886e4d-f729-4462-a528-ce6f612d3b2f/69c3b5e8-b094-4d65-b96b-9f4f3a9a8641"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("4"),
		  .ibuf_enabled("1"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("8f886e4d-f729-4462-a528-ce6f612d3b2f/2aab8a93-e7dd-4bd4-8210-42652cd079c5"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("4"),
		  .ibuf_enabled("1"),
...
module top ;
	...
	wire [0:0] tmpFB_0__Pin_ACC_net;
	wire [0:0] tmpIO_0__Pin_ACC_net;
	electrical [0:0] tmpSIOVREF__Pin_ACC_net;
	...
	cy_mxs40_gpio_v1_0
		...
		Pin_ACC
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_ACC_net[0:0]}),
		  .io({tmpIO_0__Pin_ACC_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_ACC_net));


	wire [0:0] tmpFB_0__Pin_FC_net;
	wire [0:0] tmpIO_0__Pin_FC_net;
	electrical [0:0] tmpSIOVREF__Pin_FC_net;

	cy_mxs40_gpio_v1_0
		#(.id("421ca8c8-2889-4264-b3be-145334c27105"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
		...
		Pin_FC
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_FC_net[0:0]}),
		  .io({tmpIO_0__Pin_FC_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_FC_net));
	...
	cy_mxs40_gpio_v1_0
		#(.id("00cee01f-411b-48d1-8547-ee4d444aa806"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("2"),
		  .ibuf_enabled("1"),
	...
	wire [0:0] tmpFB_0__volt_max_net;
	wire [0:0] tmpIO_0__volt_max_net;
	electrical [0:0] tmpSIOVREF__volt_max_net;

	cy_mxs40_gpio_v1_0
		#(.id("768f2684-912e-4a14-aeb0-9665c1cefa69"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
		...
		volt_max
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__volt_max_net[0:0]}),
		  .io({tmpIO_0__volt_max_net[0:0]}),
		  .siovref(tmpSIOVREF__volt_max_net));
