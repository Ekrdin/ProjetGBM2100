// ======================================================================
// Communication I2C.v generated from TopDesign.cysch
// 04/20/2021 at 13:56
...
module top ;
	...
	cy_mxs40_gpio_v1_0
		...
		INTPIN
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__INTPIN_net[0:0]}),
		  .io({tmpIO_0__INTPIN_net[0:0]}),
		  .siovref(tmpSIOVREF__INTPIN_net));


	wire [0:0] tmpFB_0__VOLTMAX_net;
	wire [0:0] tmpIO_0__VOLTMAX_net;
	electrical [0:0] tmpSIOVREF__VOLTMAX_net;
	...
	cy_mxs40_gpio_v1_0
		...
		VOLTMAX
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__VOLTMAX_net[0:0]}),
		  .io({tmpIO_0__VOLTMAX_net[0:0]}),
		  .siovref(tmpSIOVREF__VOLTMAX_net));
