...
uint8_t courant_transformer; //valeur de courant à transformer afin de l'envoyer à la communication (capteur SPO2)
...
void capSense_task()
{
    ...
    for(;;)
    {
       ...
       if(CapSense_IsWidgetActive(CapSense_BUTTON0_WDGT_ID)){
            ...
            {courant= courant+3; 
                //changement directe de courant des LED du capteur SPO2
                courant_transformer = courant/5; 
                ChangeCurrentLEDRed(courant_transformer) ;
                ChangeCurrentLEDIr (courant_transformer);
