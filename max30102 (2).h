...
/*
    GetValue_LedIr_RedLed
 parameters:   int *RedLed, Red Led Sample value
               int * LedIr, InfraRed Led sample value

    This function is used to get the sample from the red and Ir channel.
...
/*
    TaskReadingSample
 parameters:   none
This fonction is used to read the last value and stock them in a static variable for other usage.
