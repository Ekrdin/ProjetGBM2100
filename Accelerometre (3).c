...
bmi160Dev.accel_cfg.power = BMI160_ACCEL_NORMAL_MODE;
  ...
  int_config.int_type_cfg.acc_any_motion_int.anymotion_thr = 40;           // na - An interrupt will be generated if the absolute value of two consecutive accelarion signal exceeds the threshold value -> see datasheet pg32 section 2.6.1 <int_anym_th> and pg78 INT_MOTION[1]
